...
function HotelDetails() {
    ...
    const hotel = {
        ...
        price: 4500,
        description:
            "The Grand Palace Hotel is a five-star luxury stay located in the heart of Kolkata. Enjoy world-class hospitality, rooftop dining, a relaxing spa, and a vibrant cultural atmosphere.",
        amenities: [
            "Free Wi-Fi",
            "Breakfast included",
            "Swimming pool",
        ...
        images: [
            "https://via.placeholder.com/900x400?text=Main+Hotel+Image",
